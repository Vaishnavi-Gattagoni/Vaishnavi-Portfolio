...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="floating-circle w-20 h-20 top-40 right-80 animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="floating-circle w-16 h-16 bottom-40 right-60 animate-float" style={{ animationDelay: '4s' }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="hero-text">Gattagoni</span>
                <br />
                <span className="hero-text">Vaishnavi</span>
              </h1>
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative mx-auto lg:ml-auto w-80 h-96">
              ...
              <div className="absolute inset-0 rounded-3xl opacity-30 blur-2xl animate-pulse-slow"
                   style={{ background: 'var(--gradient-primary)' }}></div>
              
              <img 
                src={portraitImage}
                alt="Gattagoni Vaishnavi - Data Analyst and AI Engineer"
